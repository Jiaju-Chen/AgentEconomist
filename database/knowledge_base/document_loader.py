...
负责加载和解析 JSON 格式的学术论文，并将其转换为可索引的文档块。
"""
...
class PaperDocument:
    ...
    def get_embedding_text(self) -> str:
        """获取用于 Embedding 的文本（SPECTER2 格式）"""
...
class PaperDocumentLoader:
    ...
    def _get_intro_text(self, paper_data: Dict[str, Any]) -> str:
        """获取引言（Introduction）章节文本，如果存在则返回第一段引言全文，否则返回空字符串"""
